...
const Profile = () => {
  ...
  return (
    <>
      ...
      <img className="profileBanner" alt="banner" src={user.attributes.banner ? user.attributes.banner : defaultImgs[1]}></img>
      <div className="pfpContainer">
        <img className="profilePFP" alt="pfp" src={user.attributes.pfp ? user.attributes.pfp : defaultImgs[0]}></img>
